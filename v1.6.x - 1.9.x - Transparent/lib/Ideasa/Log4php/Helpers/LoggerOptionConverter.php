 ...
 * @since 0.5
 */
class Ideasa_Log4php_Helpers_LoggerOptionConverter {
	...
	public static function findAndSubst($key, $props) {
		...
		// If coming from the Ideasa_Log4php_Configurators_LoggerConfiguratorIni, some options were
		...
		//
		// if(!empty($value)) {
			return Ideasa_Log4php_Helpers_LoggerOptionConverter::substVars($value, $props);
		// }
	}
	 ...
	 * the call
	 * <code>
	 * $s = Ideasa_Log4php_Helpers_LoggerOptionConverter::substVars("Value of key is ${MY_CONSTANT}.");
	 * </code>
	 ...
	 * <code>
	 * $s = Ideasa_Log4php_Helpers_LoggerOptionConverter::substVars("Value of inexistentKey is [${inexistentKey}]");
	 * </code>
