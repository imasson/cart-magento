...
/**
 * Ideasa_Log4php_Appenders_LoggerAppenderRollingFile extends Ideasa_Log4php_Appenders_LoggerAppenderFile to backup the log files 
 ...
 */
class Ideasa_Log4php_Appenders_LoggerAppenderRollingFile extends Ideasa_Log4php_Appenders_LoggerAppenderFile {
	...
	public function setFile($fileName) {
		$this->file = $fileName;
		// As Ideasa_Log4php_Appenders_LoggerAppenderFile does not create the directory, it has to exist.
