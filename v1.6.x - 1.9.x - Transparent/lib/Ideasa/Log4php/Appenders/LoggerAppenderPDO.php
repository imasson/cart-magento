 ...
 * @since 2.0
 */
class Ideasa_Log4php_Appenders_LoggerAppenderPDO extends Ideasa_Log4php_LoggerAppender {
	...
	public function activateOptions() {
		try {
			...
			throw new Ideasa_Log4php_LoggerException($e);
		}
		
		$this->layout = new Ideasa_Log4php_Layouts_LoggerLayoutPattern();
	 ...
	 * 
	 * @throws Ideasa_Log4php_LoggerException If the pattern conversion or the INSERT statement fails.
	 */
	...
	public function setCreateTable($flag) {
		$this->createTable = Ideasa_Log4php_Helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
	...
	/**
	 * Sets the {@link Ideasa_Log4php_Layouts_LoggerLayoutPattern} format strings for {@link $insertSql}.
	 *
	 * It's not necessary to change this except you have customized logging.
	 *
