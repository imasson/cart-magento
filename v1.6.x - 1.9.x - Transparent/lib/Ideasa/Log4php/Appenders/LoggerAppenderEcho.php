...
/**
 * Ideasa_Log4php_Appenders_LoggerAppenderEcho uses {@link PHP_MANUAL#echo echo} function to output events. 
 * 
 ...
 */
class Ideasa_Log4php_Appenders_LoggerAppenderEcho extends Ideasa_Log4php_LoggerAppender {
	...
	public function setHtmlLineBreaks($value) {
		$this->htmlLineBreaks = Ideasa_Log4php_Helpers_LoggerOptionConverter::toBoolean($value, false);
	}
