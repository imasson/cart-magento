 ...
 *
 * @deprecated Use Ideasa_Log4php_Appenders_LoggerAppenderPDO instead
 * @package log4php
 * @subpackage appenders
 * @since 0.9
 */
class Ideasa_Log4php_Appenders_LoggerAppenderAdodb extends Ideasa_Log4php_LoggerAppender {
	...
	{		
		...
		$this->layout = Ideasa_Log4php_LoggerReflectionUtils::createObject('Ideasa_Log4php_Layouts_LoggerLayoutPattern');
	...
	function append(Ideasa_Log4php_LoggerLoggingEvent $event) {
		if ($this->canAppend) {
