 ...
 */ 
class Ideasa_Log4php_Appenders_LoggerAppenderSyslog extends Ideasa_Log4php_LoggerAppender {
	...
	public function append(Ideasa_Log4php_LoggerLoggingEvent $event) {
		...
		if(!$this->dry) {
			...
			if($this->_overridePriority) {
				...
				} else if ($level->isGreaterOrEqual(Ideasa_Log4php_LoggerLevel::getLevelError())) {
					syslog(LOG_ERR, $message);		  
				} else if ($level->isGreaterOrEqual(Ideasa_Log4php_LoggerLevel::getLevelWarn())) {
					syslog(LOG_WARNING, $message);
				} else if ($level->isGreaterOrEqual(Ideasa_Log4php_LoggerLevel::getLevelInfo())) {
					syslog(LOG_INFO, $message);
				} else if ($level->isGreaterOrEqual(Ideasa_Log4php_LoggerLevel::getLevelDebug())) {
					syslog(LOG_DEBUG, $message);
				} else if ($level->isGreaterOrEqual(Ideasa_Log4php_LoggerLevel::getLevelTrace())) {
