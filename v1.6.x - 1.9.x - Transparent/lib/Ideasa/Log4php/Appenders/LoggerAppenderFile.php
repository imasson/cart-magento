 ...
 */
class Ideasa_Log4php_Appenders_LoggerAppenderFile extends Ideasa_Log4php_LoggerAppender {
	...
	public function setAppend($flag) {
		$this->append = Ideasa_Log4php_Helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
