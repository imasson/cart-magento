 ...
 * @package log4php
 */
class Ideasa_Log4php_LoggerReflectionUtils {
		/** the target object */
	private $obj;
	
	/**
	 * Create a new Ideasa_Log4php_LoggerReflectionUtils for the specified Object. 
	...
	public static function setPropertiesByObject($obj, $properties, $prefix) {
		$pSetter = new Ideasa_Log4php_LoggerReflectionUtils($obj);
