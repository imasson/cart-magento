...
/**
 * Log objects using customized renderers that implement {@link Ideasa_Log4php_Renderers_LoggerRendererObject}.
 *
 * Example:
 ...
 * @since 0.3
 */
class Ideasa_Log4php_Renderers_LoggerRendererMap {
	...
	public function __construct() {
		$this->map = array();
		$this->defaultRenderer = new Ideasa_Log4php_Renderers_LoggerRendererDefault();
	}
	 ...
	 *
	 * @param Ideasa_Log4php_LoggerHierarchy $repository a logger repository.
	...
	public function addRenderer($renderedClassName, $renderingClassName) {
		$renderer = Ideasa_Log4php_LoggerReflectionUtils::createObject($renderingClassName);
		if($renderer == null) {
			return;
		} else {
	 ...
	 * method if <var>o</var> is object or using {@link Ideasa_Log4php_Renderers_LoggerRendererDefault}. 
	 ...
	 *
	 * @param string $class
	 * @return Ideasa_Log4php_Renderers_LoggerRendererObject
	 */
	...
	/**
	 * Register a {@link Ideasa_Log4php_Renderers_LoggerRendererObject} for <var>clazz</var>.
	 * @param string $class
	 * @param Ideasa_Log4php_Renderers_LoggerRendererObject $or
	 */
