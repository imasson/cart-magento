 ...
 *
 * <p>The <i>Ideasa_Log4php_Configurators_LoggerConfiguratorIni</i> does not handle the
 * advanced configuration features supported by the {@link Ideasa_Log4php_Configurators_LoggerConfiguratorXml} 
 * such as support for {@link Ideasa_Log4php_LoggerFilter}, 
 ...
 * <b>/home/xyz</b>. See {@link Ideasa_Log4php_Helpers_LoggerOptionConverter::getSystemProperty()}
 * for details.</p>
 *
 ...
 * @since 0.5
 */
class Ideasa_Log4php_Configurators_LoggerConfiguratorIni implements Ideasa_Log4php_LoggerConfigurator {
	 ...
	 * </pre>
	 * 
	 * For each named appender you can configure its {@link Ideasa_Log4php_LoggerLayout}. The
	 ...
	 * specifying a {@link Ideasa_Log4php_Renderers_LoggerRendererObject}
	 ...
	 * ; Appender "A1" will be a Ideasa_Log4php_Appenders_LoggerAppenderSyslog
	 * log4php.appender.A1=Ideasa_Log4php_Appenders_LoggerAppenderSyslog
	 * 
	 ...
	 * ; A2 should be a Ideasa_Log4php_Appenders_LoggerAppenderRollingFile, with maximum file size of 10 MB
	 * ; using at most one backup file. A2's layout is TTCC, using the
	 * ; ISO8061 date format with context printing enabled.
	 * log4php.appender.A2=Ideasa_Log4php_Appenders_LoggerAppenderRollingFile
	 * log4php.appender.A2.MaxFileSize=10MB
	 * log4php.appender.A2.MaxBackupIndex=1
	 * log4php.appender.A2.layout=Ideasa_Log4php_Layouts_LoggerLayoutTTCC
	 ...
	 * @param Ideasa_Log4php_LoggerHierarchy $repository the repository to apply the configuration
	 */
	public function configure(Ideasa_Log4php_LoggerHierarchy $hierarchy, $url = '') {
		$properties = @parse_ini_file($url);
		if ($properties === false) {
			$error = error_get_last();
			throw new Ideasa_Log4php_LoggerException("Ideasa_Log4php_Configurators_LoggerConfiguratorIni: Error parsing configuration file: ".$error['message']);
		}
		if  (count($properties) == 0) {
			trigger_error("Ideasa_Log4php_Configurators_LoggerConfiguratorIni: Configuration file is empty.", E_USER_WARNING);
		}
	 ...
	 * @param Ideasa_Log4php_LoggerHierarchy $hierarchy
	 */
	private function doConfigureProperties($properties, Ideasa_Log4php_LoggerHierarchy $hierarchy) {
		$thresholdStr = @$properties[self::THRESHOLD_PREFIX];
		$hierarchy->setThreshold(Ideasa_Log4php_Helpers_LoggerOptionConverter::toLevel($thresholdStr, Ideasa_Log4php_LoggerLevel::getLevelAll()));
	 ...
	 * @param Ideasa_Log4php_LoggerHierarchy $hierarchy
	 */
	private function configureRootCategory($props, Ideasa_Log4php_LoggerHierarchy $hierarchy) {
	 ...
	 * @param Ideasa_Log4php_LoggerHierarchy $hierarchy
	 */
	private function parseCatsAndRenderers($props, Ideasa_Log4php_LoggerHierarchy $hierarchy) {
