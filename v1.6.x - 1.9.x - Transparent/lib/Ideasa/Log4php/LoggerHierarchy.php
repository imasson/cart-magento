 ...
 */
  ...
  */
class Ideasa_Log4php_LoggerHierarchy {
	/** Default Factory  */
	...
	/** The root Ideasa_Log4php_Logger */
	protected $root = null;
	
	/** Ideasa_Log4php_Renderers_LoggerRendererMap */
	protected $rendererMap;

	/** Ideasa_Log4php_LoggerLevel main level threshold */
	protected $threshold;
	 ...
	 */
	public function __construct(Ideasa_Log4php_LoggerRoot $root) {
		$this->root = $root;
		$this->setThreshold(Ideasa_Log4php_LoggerLevel::getLevelAll());
		$this->rendererMap = new Ideasa_Log4php_Renderers_LoggerRendererMap();
	}
	...
	public function getLogger($name) {
		if(!isset($this->ht[$name])) {
			$this->ht[$name] = new Ideasa_Log4php_Logger($name);;
	...
	/**
	 * @return Ideasa_Log4php_Renderers_LoggerRendererMap Get the renderer map for this hierarchy.
	 */
	...
	/**
	 * @return Ideasa_Log4php_LoggerRoot Get the root of this hierarchy.
	 */ 
	public function getRootLogger() {
		if(!isset($this->root) or $this->root == null) {
			$this->root = new Ideasa_Log4php_LoggerRoot();
		}
		return $this->root;
	}
	 
	/**
	 * @return Ideasa_Log4php_LoggerLevel Returns the threshold Level.
	 */
	 ...
	 *
	 * @param Ideasa_Log4php_LoggerLevel $l
	 */
	public function setThreshold(Ideasa_Log4php_LoggerLevel $l) {
		if($l !== null) {
			$this->threshold = $l;
		}
	}
