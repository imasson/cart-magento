 ...
 * @subpackage layouts
 */
class Ideasa_Log4php_Layouts_LoggerLayoutXml extends Ideasa_Log4php_LoggerLayout {
	...
	public function setLocationInfo($flag) {
		$this->locationInfo = Ideasa_Log4php_Helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
	...
	public function setLog4jNamespace($flag) {
		$this->log4jNamespace = Ideasa_Log4php_Helpers_LoggerOptionConverter::toBoolean($flag, true);
	}
