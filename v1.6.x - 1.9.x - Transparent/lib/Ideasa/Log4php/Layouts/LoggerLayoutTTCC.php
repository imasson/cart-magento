 ...
 * @subpackage layouts
 */
class Ideasa_Log4php_Layouts_LoggerLayoutTTCC extends Ideasa_Log4php_LoggerLayout {
	...
	public function setCategoryPrefixing($categoryPrefixing) {
		$this->categoryPrefixing = Ideasa_Log4php_Helpers_LoggerOptionConverter::toBoolean($categoryPrefixing);
	}
	...
	public function setContextPrinting($contextPrinting) {
		$this->contextPrinting = Ideasa_Log4php_Helpers_LoggerOptionConverter::toBoolean($contextPrinting); 
	}
