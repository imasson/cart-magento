 ...
 * @subpackage layouts
 */
class Ideasa_Log4php_Layouts_LoggerLayoutHtml extends Ideasa_Log4php_LoggerLayout {
	 ...
	 *
	 * <p>If you are embedding this layout within a {@link Ideasa_Log4php_Appenders_LoggerAppenderMail}
	 * or a {@link Ideasa_Log4php_Appenders_LoggerAppenderMailEvent} then make sure to set the
	...
	public function format(Ideasa_Log4php_LoggerLoggingEvent $event) {
		...
		} else if ($level->equals(Ideasa_Log4php_LoggerLevel::getLevelWarn())) {
