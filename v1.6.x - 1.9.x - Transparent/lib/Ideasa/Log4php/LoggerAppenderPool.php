...
/**
 * Pool implmentation for Ideasa_Log4php_LoggerAppender instances
 *
 * @version $Revision: 795727 $
 * @package log4php
 */
class Ideasa_Log4php_LoggerAppenderPool {
	/* Appender Pool */
	...
	public static function getAppenderFromPool($name, $class = '') {
		...
		$appender = Ideasa_Log4php_LoggerReflectionUtils::createObject($class);
